...
if(!HttpRequest._maxParallel)
{
	HttpRequest._maxParallel = 0;
}

var c = Object_slotCount(HttpRequest._inProgress);
if(c > HttpRequest._maxParallel)
{
	HttpRequest._maxParallel = c;
	Log.writeln(c, " requests in progress");
}
