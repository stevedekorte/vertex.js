...
PNodePermissions = Proto.clone().newSlots({	
	...
	{
		return "user:" + this._user + " group:" + this._group + " mode:" + this._access;
	},
	
	read: function()
	{
		this._user   = this._node.mread("user")
		this._group  = this._node.mread("group")
		this._access = this._node.mread("access") // rwxrwxrwx
	...
	write: function()
	{
		this._node.mwrite("user", this._user)
		this._node.mwrite("group", this._group)
		this.updateAccess();
		this._node.mwrite("access", this._access)
	},
